package vttp.csf.server.constant;
...
public class SecurityConstant {
    ...
    public static final String ISAAC_ADMINISTRATION = "User Management Portal"; // who is this token for?
    ...
    public static final String OPTIONS_HTTP_METHOD = "OPTIONS"; // if the http method is not GET or POST or etc i.e. if it is option, you want to let it go through
